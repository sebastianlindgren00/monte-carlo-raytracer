...
ColorDBL::ColorDBL(const glm::dvec3& color) : r(color.x), g(color.y), b(color.z) {}
...
// scalar multiplicator with scalar on the left side
ColorDBL operator*(double scalar, const ColorDBL& color) {
    return color * scalar;
}
