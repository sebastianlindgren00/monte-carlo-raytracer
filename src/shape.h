...
class Plane : public Shape {
    public:
    Plane(glm::dvec3 topLeft, glm::dvec3 topRight, glm::dvec3 bottomLeft, glm::dvec3 bottomRight, Material material) : Shape(material), bottomLeft(bottomLeft), topLeft(topLeft), bottomRight(bottomRight), topRight(topRight), normal(glm::normalize(glm::cross(bottomRight - bottomLeft, topLeft - bottomLeft))) {}
...
public:
    Sphere(glm::dvec3 center, double radius, Material material) : Shape(material), center(center), radius(radius) {}
...
public:
    Triangle(glm::dvec3 top, glm::dvec3 baseLeft, glm::dvec3 baseRight, Material material) : Shape(material), top(top), baseLeft(baseLeft), baseRight(baseRight), normal(glm::normalize(glm::cross(baseLeft - top, baseRight - top))) {}
